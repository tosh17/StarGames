...
import ru.geekbrains.stargame.hp.HP;
...
public class GameScreen extends Base2DScreen implements ActionListener {
    ...
    public void show() {
        ...
        hps=new HP(worldBounds);
        hpTexture=new Texture(Gdx.files.internal("hps.png"));
    ...
    public void printInfo() {
        ...
        batch.draw(hpTexture,worldBounds.pos.x, worldBounds.pos.y);
